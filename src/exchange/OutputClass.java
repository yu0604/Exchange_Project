...
public class OutputClass {
	...
	public void printEURO(double exchangeResult, int eur, int eur500, int eur200, int eur100, int eur50, int eur20, int eur10, int eur5) {
		System.out.printf("유로로 환전 결과 : %.2f유로\n", exchangeResult);
		System.out.println("유로 지급 : " + eur + "유로");
		System.out.println("-500유로: " + eur500 + "장");
		System.out.println("-200유로: " + eur200 + "장");
